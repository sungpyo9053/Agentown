...
async function handle(job) {
  ...
  for (const agent of job.agents) {
    ...
    await request(`/api/runner/jobs/${job.executionId}/events`, { method: "POST", body: JSON.stringify({ eventType: "STEP_OUTPUT_CREATED", agentId: agent.agentId, stepKey: agent.stepKey }) });
