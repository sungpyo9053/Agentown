...
export default function AdminPage(){
 ...
 return <AppShell kicker="PLATFORM ADMIN" title="Agentown 전체 운영 콘솔">
  <div className="mb-5 flex justify-end"><Link href="/admin/releases" className="rounded-xl bg-ink px-5 py-3 text-sm font-black text-white">Releases · 배포 검토</Link></div>
