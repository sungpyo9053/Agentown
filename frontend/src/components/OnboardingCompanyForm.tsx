...
const defaultNextPath = "/assemble/automation";

export function OnboardingCompanyForm({ nextPath = defaultNextPath }: { nextPath?: string }) {
  const router = useRouter();
  const next = internalPathOrFallback(nextPath, defaultNextPath);
