...
enum class BuilderRunStatus { QUEUED, GENERATING, RUNNING, WAITING_APPROVAL, PUBLISHING, SUCCEEDED, FAILED, AMBIGUOUS, EXECUTION_NOT_CONFIGURED }
enum class BuilderRunMode { SIMULATION, PRODUCTION }
...
enum class NodeType(val wireName: String, val riskLevel: String) {
    ...
    LOCAL_WEB_RESEARCH("local.web.research", "MEDIUM"),
    ...
    NOTION_CREATE_PAGE("notion.create_page", "HIGH");
