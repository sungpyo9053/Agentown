...
interface BuilderWorkflowRepository : JpaRepository<BuilderWorkflow, UUID> { fun findByIdAndWorkspaceId(id: UUID, workspaceId: UUID): BuilderWorkflow?; fun findByConversationId(conversationId: UUID): BuilderWorkflow? }
